...
import { LogOut, User, ChevronDown, ChevronRight, Home, SquareKanban, Newspaper } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    // Extract user roles
    const userRoles = user?.roles?.map((role: { role_type: any; }) => role.role_type) || [];
